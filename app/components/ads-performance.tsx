      ...
      <div className="mt-24 px-8">
        ...
        <div className="grid grid-cols-3 gap-6 mb-8 max-w-7xl mx-auto">
                ...
                <div
                  className={`text-sm font-semibold ${
                    metrics.activeUsersYesterday.trend === "up"
                      ? "text-green-600"
                      : metrics.activeUsersYesterday.trend === "down"
                      ? "text-red-600"
                      : "text-gray-600"
                  }`}
                >
                  {metrics.activeUsersYesterday.trend === "up"
                    ...
                    : "→"}{" "}
                  {Math.abs(
                    metrics.activeUsersYesterday.percentageChange
                  ).toFixed(1)}
                  %
                </div>
              </div>
            )}
            <div className="text-6xl font-bold text-green-600 mb-4 text-center">
              {metrics?.activeUsersYesterday.value
                ? formatEuropeanInteger(metrics.activeUsersYesterday.value)
                : 0}
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div
                  className={`text-sm font-semibold ${
                    metrics.activeUsers7days.trend === "up"
                      ? "text-green-600"
                      : metrics.activeUsers7days.trend === "down"
                      ? "text-red-600"
                      : "text-gray-600"
                  }`}
                >
                  {metrics.activeUsers7days.trend === "up"
                    ...
                    ? "↘"
                    : "→"}{" "}
                  {Math.abs(metrics.activeUsers7days.percentageChange).toFixed(
                    1
                  )}
                  %
                </div>
            ...
            <div className="text-6xl font-bold text-gray-900 mb-4 text-center">
              {metrics?.activeUsers7days.value
                ? formatEuropeanInteger(metrics.activeUsers7days.value)
                : 0}
            </div>
            <div className="text-xl text-gray-700 font-semibold text-center">
              Usuarios Activos
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="text-6xl font-bold text-gray-900 mb-4 text-center">
              {formatEuropeanInteger(registeredUsers || 0)}
            </div>
            <div className="text-xl text-gray-700 font-semibold text-center">
              Usuarios Activos
            </div>
        ...
        <div className="grid grid-cols-2 gap-6 mb-6 max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-7">
            <h3 className="text-xl font-bold text-gray-900 mb-2 text-center">
              Usuarios Activos por Sistema Operativo
            </h3>
                  ...
                  {osData.slice(0, 7).map((os, index) => (
                    ...
                    >
                      ...
                      <div className="text-center text-gray-700 font-semibold">
                        {os.users >= 1000
                          ? `${(os.users / 1000).toFixed(1)}k`
                          : formatEuropeanInteger(os.users)}
                      </div>
                    </div>
                  ))}
                </div>
                    ...
                    >
                      ...
                      <div className="text-center text-gray-700 font-semibold">
                        {country.users >= 1000
                          ...
                          : formatEuropeanInteger(country.users)}
                      </div>
                    </div>
                  ))}
                </div>
